...
class StoreSummaryEntity {
  ...
  final Map<PaymentMethod, List<PaymentItemEntity>> _itemsGroupsMap;
  double _totalBalance = 0;

  StoreSummaryEntity({
    required StoreEntity store,
    required Map<PaymentMethod, List<PaymentItemEntity>> itemsGroupsMap,
  })  : _store = store,
  ...
  void _initTotalBalance(
      Map<PaymentMethod, List<PaymentItemEntity>> itemsGroupsMap) {
    final allItems =
  ...
  Map<PaymentMethod, List<PaymentItemEntity>> get itemsGroupsMap =>
      _itemsGroupsMap;
