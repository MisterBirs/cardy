...
import 'package:cardy/features/brands/application/brands_bloc.dart';
  ...
  runApp(
    MultiBlocProvider(
      providers: [
        ...
        BlocProvider<CategoriesCubit>(create: (_) => getIt<CategoriesCubit>()),
        BlocProvider<BrandsBloc>(
          create: (_) => getIt<BrandsBloc>(),
        ),
        BlocProvider<UserItemsBloc>(
          create: (_) => getIt<UserItemsBloc>(),
        ),
      ],
      child: CardyApp(),
    ),
