...
//Sizes
const SPACING_S = 10.0;
const SPACING_M = 20.0;
const SPACING_L = 30.0;
const ICON_SIZE = 30.0;
const SQUARE_CARD_RATIO = 1.585;
const SCREEN_HORIZONTAL_PADDING = SPACING_M;
const PADDING_FROM_TOP_SCREEN = SPACING_L;
const CONTAINER_HORIZONTAL_PADDING = 15.0;
const APP_BAR_TOP_SPACING = kToolbarHeight + 15.0;
const BASE_ITEM_TILE_SIZE = 100.0;
const BIG_ITEM_TILE_SIZE = 130.0;
