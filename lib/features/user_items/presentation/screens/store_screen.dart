...
import 'package:cardy/features/user_items/presentation/widgets/item_tiles/grid_tiles/item_grid_custom_tile.dart';
import 'package:cardy/features/user_items/presentation/widgets/show_all_items_list/show_all_items_list.dart';
import 'package:cardy/core/presentation/widgets/app_bars/back_add_app_bar.dart';
...
import 'package:cardy/features/user_items/presentation/widgets/show_all_items_list/custom_show_all_items_list.dart';
...
class StoreScreen extends StatelessWidget {
  ...
  Widget get itemsLists {
    return Column(
      ...
      children: storeSummary.itemsGroupsMap.entries
        ...
        final List<UserItemEntity> items = itemsGroupEntry.value;
  ...
  ShowAllItemsList _imageItemsList(
      String label, List<UserItemEntity> items, void Function() onAdd) {
  ...
  Widget buildNoImageItemTile(UserItemEntity item) {
